...
import Ajv from "ajv";
import { addWatcher, getWatcherByRequestID, clearAllWatchers } from "./watcher.js";
import { findFromHistory, clearHistory } from "./history.js";
import { requestSchema } from "./schema.js";

const debug = dbg("rwatchd:api");
 ...
 * @param {number} request.numAllowFirstFewEmptyOutput - keep watching if cmd returns empty ouput first few times
 ...
 * @param {number} request.rt - return code from cmd when it was last executed
 ...
 */
export function replaceCmd (id, cmd) {
